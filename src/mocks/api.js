...
const TOKENS = {
  "admin@geodesa.com": {
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxIiwibmFtZSI6IkFkbWluaXN0cmFkb3IiLCJlbWFpbCI6ImFkbWluQGdlb2Rlc2EuY29tIiwicm9sZSI6ImFkbWluIiwiZXhwIjoxNjc2NTU2ODAwfQ.8rTg5JnFiYW3EJ0CelwgN38WsD3aPLM4LxvV9Evc6Fs",
    user: {
      id: 1,
      name: "Administrador",
  ...
  "especialista@geodesa.com": {
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIyIiwibmFtZSI6IkVzcGVjaWFsaXN0YSIsImVtYWlsIjoiZXNwZWNpYWxpc3RhQGdlb2Rlc2EuY29tIiwicm9sZSI6InNwZWNpYWxpc3QiLCJleHAiOjE2NzY1NTY4MDB9.L6-J7NQ9zV8HZ2M9JEyGGF8JnxRnUJKqLZcXDfXcpQ8",
    user: {
      id: 2,
      name: "Especialista",
  ...
  "usuario@geodesa.com": {
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzIiwibmFtZSI6IlVzdWFyaW8gR2VuZXJhbCIsImVtYWlsIjoidXN1YXJpb0BnZW9kZXNhLmNvbSIsInJvbGUiOiJ1c2VyIiwiZXhwIjoxNjc2NTU2ODAwfQ.7dY1v9hpNcLH7KmR5ZKJYsTsHXa8DYpzC8Z8W4JxPDk",
    user: {
      id: 3,
