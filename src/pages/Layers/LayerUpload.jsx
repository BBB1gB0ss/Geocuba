...
import { FiUpload, FiFile, FiX, FiTag, FiCalendar, FiInfo } from 'react-icons/fi'
...
const LayerUpload = () => {
  ...
  const { getRootProps, getInputProps, isDragActive } = useDropzone({
    ...
    onDropRejected: fileRejections => {
      ...
      if (rejection.errors[0].code === 'file-too-large') {
        ...
        setError('Formato de archivo no soportado. Por favor, suba un archivo GeoTIFF, Shapefile o GeoJSON.')
      }
    }
  })
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Navigate to layers list with success message
      setTimeout(() => {
        navigate('/layers', { 
          state: { 
            alert: {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Complete el formulario y suba el archivo para añadir una nueva capa al sistema.
        </p>
      </div>
                ...
                {file ? (
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Arrastre y suelte el archivo aquí, o haga clic para seleccionarlo
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  id="format"
                  className={`block w-full rounded-md shadow-sm ${
                    errors.format ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 
                    'border-gray-300 focus:ring-primary-500 focus:border-primary-500'
                  }`}
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    type="text"
                    className={`block w-full pl-10 rounded-md shadow-sm ${
                      errors.keywords ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 
                      'border-gray-300 focus:ring-primary-500 focus:border-primary-500'
                    }`}
                    placeholder="Ej: topografía, relieve, elevación"
                    {...register('keywords', { required: 'Las palabras clave son obligatorias' })}
                  />
                </div>
                {errors.keywords && (
              ...
              {/* Projection */}
              <div>
                <label htmlFor="projection" className="block text-sm font-medium text-gray-700 mb-1">
                  Proyección
                </label>
                <input
                  id="projection"
